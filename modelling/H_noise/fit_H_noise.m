% Fits Glaze model with 2 free parameters: H and response noise

function [pm_fit,err] = fit_H_noise(subj)

% Set global variables to pass to PSO algorithm
global LLRin choices nsamps

% Path stuff
addpath /mnt/homes/home024/pmurphy/Surprise_scz/modelling/H_noise/
...
savepath = '/mnt/homes/home024/pmurphy/Surprise_scz/modelling/H_noise/fits/';
...
% Running PSO routine
[output,te,tr] = pso_Trelea_vectorized_Glaze('CE_H_noise',length(mv),mv,par_range,0,P,'goplotpso',PSOseedValue);
