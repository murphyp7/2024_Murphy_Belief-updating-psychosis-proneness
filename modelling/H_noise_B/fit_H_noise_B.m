% Fits Glaze model with 3 free parameters: H, response noise and B (gain on
% evidence)

function [pm_fit,err] = fit_H_noise_B(subj)
...
% Path stuff
addpath /mnt/homes/home024/pmurphy/Surprise_scz/modelling/H_noise_B/
...
savepath = '/mnt/homes/home024/pmurphy/Surprise_scz/modelling/H_noise_B/fits/';
...
par_range = [range_p.H; range_p.noise; range_p.B];
...
% Running PSO routine
[output,te,tr] = pso_Trelea_vectorized_Glaze('CE_H_noise_B',length(mv),mv,par_range,0,P,'goplotpso',PSOseedValue);
