...
function [pm_fit,err] = fit_H_noise_IU(subj)
...
% Path stuff
addpath /mnt/homes/home024/pmurphy/Surprise_scz/modelling/H_noise_IU/
...
savepath = '/mnt/homes/home024/pmurphy/Surprise_scz/modelling/H_noise_IU/fits/';
...
% Running PSO routine
[output,te,tr] = pso_Trelea_vectorized_Glaze('CE_H_noise_IU',length(mv),mv,par_range,0,P,'goplotpso',PSOseedValue);
