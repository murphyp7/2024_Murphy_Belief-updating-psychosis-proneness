...
function data = surprise_trialfun(data,sess,b)
...
trl = zeros(length(trialinds),10);  % initializing trial content matrix
...
for i = 1:length(trialinds)
    ...
    trl(i,:) = [s-1 stimonsmp responsmp respsmp respdir ACC RT sess b trial_num];
end
